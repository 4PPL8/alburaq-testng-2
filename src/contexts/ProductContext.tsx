...
const initialProducts: Product[] = [
	{
		...
		images: ['/balo-color-1.jpg', '/balo-color-3.png', '/balo-color-2.png'],
	...
	},
	{
		...
		images: ['/belo-color-brown-0.png', '/balo-color-brown-1.png', '/balo-color-brown-2.png', '/balo-color-brown-3.png'],
		features: ['Rich brown tone', 'Long-lasting color', 'Natural ingredients']
	},
	{
		id: '2',
		name: 'Grace Color',
		...
		images: ['/grace-color-0.png', '/grace-color-2.png', '/grace-color-1.jpg', '/grace-color-3.png'],
	...
	},
	{
		...
		images: ['/grace-color-brown-1.png', '/grace-color-brown-2.png', '/grace-color-brown-3.png'],
		features: ['Rich brown shade', 'Excellent coverage', 'Hair-friendly formula']
	},
	{
		id: '3',
		name: 'Veloria Facial',
		...
		images: ['/veloria-facial-2.png', '/veloria-facial-1.jpg', '/veloria-facial-3.png'],
	...
	},
	{
		...
		images: ['/grace-bleach-1.png', '/grace-bleach-2.png', '/grace-bleach-3.png'],
		features: ['Mild formula for sensitive skin', 'Instant glow', 'Easy to use']
	},
	{
		id: '42',
		...
		images: ['/veloria-skin-polish-1.png', '/veloria-skin-polish-2.png', '/veloria-skin-polish-3.png'],
		features: ['Deep exfoliation', 'Brightens skin', 'Suitable for all skin types']
	},
	{
		id: '43',
		...
		images: ['/veloria-remover-1.png', '/veloria-remover-2.png', '/veloria-remover-3.png'],
		features: ['Quick and painless', 'Removes fine hair', 'Leaves skin moisturized']
	},
	{
		id: '44',
		name: 'Veloria Bleach',
		...
		images: ['/veloria-bleach-1.png', '/veloria-bleach-2.png', '/veloria-bleach-3.png'],
		features: ['Herbal ingredients', 'Fast results', 'No skin irritation']
	},
	{
		id: '45',
		name: 'Hit Lotion',
		...
		images: ['/hit-lotion-0.png', '/hit-anti-mosquito-lotion-1.jpg', '/hit-anti-mosquito-lotion-2.png'],
		features: ['Soft and fragrant', 'Contains Vitamin E & Lavender', 'Long-lasting protection']
	},
	{
		id: '46',
		name: 'Neat Remover',
		...
		images: ['/neat-remover-1.png', '/neat-remover-2.png', '/neat-remover-3.png'],
		features: ['Easy to apply', 'Works in minutes', 'Smooth skin after use']
	},
	{
		id: '53',
		name: 'Neat Bleach',
		...
		images: ['/neat-bleach-1.png', '/neat-bleach-2.png', '/neat-bleach-3.png', '/neat-bleach-4.png'],
		features: ['Gentle on skin', 'Brightens complexion', 'Easy application']
	},
	// Razors
	{
		id: '4',
		...
		images: ['/sharp-razor-1.jpg', '/sharp-razor-2.png', '/sharp-razor-3.png'],
	...
	},
	{
		...
		images: ['/ujala-razor-1.jpg', '/ujala-razor-2.jpg', '/ujala-razor-3.png'],
	...
	},
	{
		...
		images: ['/turk-razor-1.png', '/turk-razor-2.png', '/turk-razor-3.png'],
		features: ['Sharp and durable blade', 'Comfortable grip', 'Suitable for all skin types']
	},
	{
		id: '54',
		...
		images: ['/sharp-hygiene-razor-1.png', '/sharp-hygiene-razor-2.png', '/sharp-hygiene-razor-3.png', '/sharp-hygiene-razor-4.png'],
		features: ['Hygienic design', 'Safe for sensitive skin', 'Comfortable grip']
	},
	{
		id: '55',
		...
		images: ['/sharp-paki-razor-1.png', '/sharp-paki-razor-2.png', '/sharp-paki-razor-3.png'],
		features: ['Traditional style', 'Precise shaving', 'Durable blade']
	},
	// Toothbrush
	{
		id: '6',
		...
		images: ['/mister-clean-toothbrush-1.jpg', '/mister-clean-toothbrush-2.jpg', '/mister-clean-toothbrush-3.png'],
	...
	// Agarbatti (Incense Sticks)
	{
		...
		images: ['/mahfil-milan-1.jpg', '/mahfil-milan-1.jpg', '/mahfil-milan-2.png'],
	...
	},
	{
		...
		images: ['/mehfil-millan-extra-1.png', '/mehfil-millan-extra-2.jpg', '/mehfil-millan-extra-3.png'],
	...
	},
	{
		...
		images: ['/golden-milan-2.png', '/golden-milan-1.jpg', '/golden-milan-3.png'],
	...
	},
	{
		...
		images: ['/jor-joshanda-1.jpg', '/jor-joshanda-2.jpg', '/jor-joshanda-3.png'],
	...
	},
	{
		...
		images: ['/natural-isp-2.jpg'],
		features: ['Supports digestion', 'Natural fiber', 'Easy to use']
	},
	// Adhesive Tape
	{
		id: '11',
		...
		images: ['/lemn-adhesive-tape-1.jpg', '/lemon-adhesive-tape-2.jpg', DefaultProductPlaceholder],
	...
	},
	{
		...
		images: ['/dark-red-tape-1.jpg', DefaultProductPlaceholder, DefaultProductPlaceholder],
	...
	},
	{
		...
		images: ['/brown-tape-1.jpg', DefaultProductPlaceholder, DefaultProductPlaceholder],
	...
	},
	{
		...
		images: ['/super-yellowish-tape-1.jpg', DefaultProductPlaceholder, DefaultProductPlaceholder],
	...
	},
	{
		...
		images: ['/masking-tape-1.jpg', DefaultProductPlaceholder, DefaultProductPlaceholder],
	...
	},
	{
		...
		images: ['/transparent-tape-1.jpg', DefaultProductPlaceholder, DefaultProductPlaceholder],
	...
	// PVC Tape
	{
		...
		images: ['/hit-tape-2.png', '/hit-tape-1.jpg', '/hit-tape-3.png'],
	...
	},
	{
		...
		images: ['/snake-tape-1.jpg', '/snake-tape-2.png', '/snake-tape-3.png'],
	...
	},
	{
		...
		images: ['/gold-tape-1.jpg', '/gold-tape-2.png', '/gold-tape-3.png'],
	...
	// Stationery
	{
		...
		images: ['/lead-pencil-1.jpg', '/lead-pencil-2.png'],
	...
	},
	{
		...
		images: ['/color-pencil-1.png', '/sonex-2.png', '/sonex-3.png'],
	...
	},
	{
		...
		images: ['/color-pencil-2.png', '/color-pencil-3.png', '/good-3.png'],
	...
	// Stationery Tapes
	{
		...
		images: ['https://placehold.co/400x400/6A5ACD/FFFFFF?text=333+Tape', DefaultProductPlaceholder, DefaultProductPlaceholder],
	...
	},
	{
		...
		images: ['https://placehold.co/400x400/DA70D6/FFFFFF?text=555+Tape', DefaultProductPlaceholder, DefaultProductPlaceholder],
	...
	// Baby Products (Soothers)
	{
		...
		images: ['/silicon-nipple-1.jpg', '/silicon-nipple-3.png', '/silicon-nipple-4.png'],
	...
	},
	{
		...
		images: ['/camera-nipple-1.jpg', '/camera-nipple-2.png', '/camera-nipple-3.png'],
	...
	// Cleaning Products
	{
		...
		images: ['/grace-bright-1.jpg', '/grace-bright-2.png'],
	...
	},
	{
		...
		images: ['/grace-bright-3.png', '/grace-bright-4.png'],
		features: ['Streak-free clean', 'Fast-acting', 'Fresh scent']
	},
	{
		id: '36',
		...
		images: ['/shine-x-scourer-1.jpg', '/shine-x-scourer-4.png', '/shine-x-scourer-5.png'],
	...
	},
	{
		...
		images: ['/shine-x-scourer-2.png', '/shine-x-scourer-6.png', '/shine-x-scourer-7.png'],
		features: ['Removes tough stains', 'Durable', 'Easy to grip']
	},
	{
		id: '59',
		...
		images: ['/shine-x-scourer-3.png', '/shine-x-scourer-8.png'],
		features: ['Removes tough stains', 'Durable', 'Easy to grip']
	},
	{
		id: '37',
		...
		image: '/tissue-1.jpg',
		images: ['/tissue-1.jpg', '/tissue-2.png', '/tissue-3.png'],
	...
	// Pest Control
	{
		...
		images: ['/rat-book-1.jpg', '/rat-book-2.png', '/rat-book-3.png'],
	...
	// Craft Supplies
	{
		...
		images: ['/turk-elfi-1.png', '/turk-elfi-2.png'],
		features: ['Strong hold', 'Quick drying', 'Multipurpose use']
	},
	{
		id: '48',
		...
		images: ['/turk-glue-20g-1.jpg', '/turk-glue-20g-2.png'],
		features: ['20g tube', 'Easy to apply', 'Strong and fast bonding']
	},
	{
		id: '49',
		...
		images: ['/turk-glue-50g-1.png', '/turk-glue-50g-2.png'],
		features: ['50g capacity', 'Ideal for large projects', 'Durable, strong hold']
	}
];
...
export const ProductProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	...
	useEffect(() => {
		...
		loadProducts();
		const handleProductsSynced = (event: CustomEvent) => { setProducts(event.detail.products); };
		const handleForceSync = (event: CustomEvent) => { setProducts(event.detail.products); };
		const handleGitHubProductsSynced = (event: CustomEvent) => { setProducts(event.detail.products); };
	...
	useEffect(() => { setCanUndo(dataService.getLastChange() !== null); }, [products, dataService]);

	const saveProducts = async (newProducts: Product[]) => { setProducts(newProducts); await dataService.saveProducts(newProducts); };

	const categories = [
		'Cosmetics & Personal Care', 'Razors', 'Toothbrush', 'Agarbatti (Incense Sticks)', 'Natural / Herbal Products', 'Adhesive Tape', 'PVC Tape', 'Stationery', 'Stationery Tapes', 'Baby Products (Soothers)', 'Cleaning Products', 'Pest Control', 'Craft Supplies'
	];

	const addProduct = async (product: Omit<Product, 'id'>) => {
		const newProduct: Product = { ...product, id: Date.now().toString(), images: product.images && product.images.length > 0 ? product.images : [product.image] };
		dataService.addChange({ action: 'add', previousData: newProduct, newData: newProduct, description: `Added product: ${newProduct.name}` });
		const newProducts = [...products, newProduct];
		await saveProducts(newProducts);
	};

	const clearProductsData = () => { dataService.clearChangeHistory(); setProducts(initialProducts); dataService.saveProducts(initialProducts); };

	const updateProduct = async (id: string, updatedProduct: Omit<Product, 'id'>) => {
		const existingProduct = products.find(p => p.id === id);
		if (!existingProduct) return;
		dataService.addChange({ action: 'update', previousData: existingProduct, newData: { ...updatedProduct, id }, description: `Updated product: ${existingProduct.name}` });
		const processedProduct = { ...updatedProduct, id, images: updatedProduct.images && updatedProduct.images.length > 0 ? updatedProduct.images : [updatedProduct.image] };
		const newProducts = products.map(product => (product.id === id ? processedProduct : product));
		await saveProducts(newProducts);
	};
	...
	const deleteProduct = async (id: string) => {
		const existingProduct = products.find(p => p.id === id);
		if (!existingProduct) return;
		dataService.addChange({ action: 'delete', previousData: existingProduct, newData: undefined, description: `Deleted product: ${existingProduct.name}` });
			...
			if (undoResult.success && undoResult.restoredData !== undefined) {
				if (undoResult.restoredData.length === 0) {
					...
					undoResult.restoredData.forEach(restoredProduct => {
						...
						if (existingIndex >= 0) { newProducts[existingIndex] = restoredProduct; } else { newProducts.push(restoredProduct); }
					});
					await saveProducts(newProducts);
				}
				return { success: true, message: undoResult.message };
			} else { return { success: false, message: undoResult.message }; }
		} catch (error) { console.error('Error undoing last change:', error); return { success: false, message: 'Failed to undo last change' }; }
	};
	...
	return (
		<ProductContext.Provider value={{ products, isLoading, categories, addProduct, updateProduct, deleteProduct, getProduct, getProductsByCategory, clearProductsData, undoLastChange, canUndo, syncStatus: { syncing: false, lastSynced: dataService.getLastSyncTimestamp() ? new Date(dataService.getLastSyncTimestamp()!) : null, error: null, isGitHubSyncEnabled: dataService.isGitHubSyncEnabled() } }}>
			{children}
		</ProductContext.Provider>
	);
};

export const useProducts = () => { const context = useContext(ProductContext); if (context === undefined) { throw new Error('useProducts must be used within a ProductProvider'); } return context; };